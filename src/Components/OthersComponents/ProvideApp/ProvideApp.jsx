            ...
            <div className="app-content">
                <div className="app-text-container">
                    ...
                    <div className="app-buttons">
                        <Link to="https://play.google.com/store/apps/developer?id=PREPSEED" target="_blank"><button className="app-btn primary-btn">
                        ...
                        <Link to="https://apps.apple.com/us/developer/markseasy-preparation-private-limited/id1449014314" target="_blank">
