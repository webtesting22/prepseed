...
const PreviewDetails = () => {
  ...
  const personalData = {
    ...
    description:
      "Transform your business with our comprehensive digital platform solution. We provide end-to-end services tailored to your industry needs.",
  };
        ...
        <Card className="candidate-card" bordered={false}>
          ...
          <div className="card-header">
            ...
            <div className="candidate-basic-info">
              ...
              <Space align="center" className="location-info">
                ...
                <Text type="secondary">
                  {selectedIndustry?.name || "Industry Selection Pending"}
                </Text>
              </Space>
            </div>
          </div>
          ...
          {selectedModulesDetails.length > 0 && (
            <div className="modules-section">
              <Text strong>
                Selected Modules ({selectedModulesDetails.length})
              </Text>
          ...
          <div className="setup-timeline-section">
            ...
            <div className="timeline-section">
              <Timeline>
                ...
                >
                  <Text>
                    Modules Selection {selectedModules?.length > 0 ? "✓" : "⏳"}
                  </Text>
                </Timeline.Item>
                <Timeline.Item
                  dot={
                ...
                >
                  <Text>
                    Identity Setup {isPersonalInfoComplete() ? "✓" : "⏳"}
                  </Text>
                </Timeline.Item>
              </Timeline>
            </div>
