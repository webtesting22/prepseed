...
const LogoUploadContainer = () => {
      ...
      try {
        ...
        const colorsWithHex = [
          ...
          ...palette.slice(0, 5).map((color, index) => ({
            ...
            label:
              ["Secondary", "Accent", "Tertiary", "Quaternary", "Quinary"][
                index
              ] || `Color ${index + 2}`,
          })),
        ];
  ...
  return (
    <div className="step-content">
      ...
      >
        This is where you can overview your project setup and configure your
        portal step by step.
      </p>
      ...
      {extractedColors.length > 0 && (
        <div style={{ marginBottom: "32px" }}>
          ...
          >
            Click to select up to 2 colors for your brand theme (
            ...
            {extractedColors.map((color, index) => (
              <div
                ...
                style={{
                  padding: "16px",
                  border: `2px solid ${
                    isColorSelected(color) ? "#3b82f6" : "#e2e8f0"
                  }`,
                  borderRadius: "8px",
                  background: isColorSelected(color) ? "#f0f9ff" : "white",
                  cursor: "pointer",
                  transition: "all 0.2s",
                  position: "relative",
                }}
