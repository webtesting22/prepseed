                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-section">
                            <div className="company-info">
                                <h2 className="company-name">One Platform. Endless Clarity.</h2>
                                <p className="company-tagline">Bring everything into one streamlined workspace—automate workflows, sync data, and keep everyone aligned</p>
                            </div>
